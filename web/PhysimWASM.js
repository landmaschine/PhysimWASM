...
// include: C:\Users\leon\AppData\Local\Temp\tmph27dwpqn.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Users/leon/Documents/dev/PhysimWASM/web/PhysimWASM.data';
      var REMOTE_PACKAGE_BASE = 'PhysimWASM.data';
...
Module['FS_createPath']("/assets/shaders", "OpenGL", true, true);
Module['FS_createPath']("/assets/shaders", "OpenGLES3", true, true);
Module['FS_createPath']("/assets", "textures", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_C:/Users/leon/Documents/dev/PhysimWASM/web/PhysimWASM.data');

      };
      Module['addRunDependency']('datafile_C:/Users/leon/Documents/dev/PhysimWASM/web/PhysimWASM.data');
...
function findWasmBinary() {
    return locateFile('PhysimWASM.wasm');
}
...
var _updateCanvasSize = Module['_updateCanvasSize'] = createExportWrapper('updateCanvasSize', 0);
